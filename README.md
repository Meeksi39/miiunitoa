...
プライマリディスプレイ）を保存し、トップバーのメニューまたはコマンドラインから
切り替えるためのツールです。
...
または**トップバー**から: ディスプレイアイコンをクリックしてレイアウトを選びます。
「Display Settings…」項目で GNOME のディスプレイ設定パネルが開きます。メニューは
開くたびに再構築されるため、CLI で保存したレイアウトも拡張機能を再読み込みせずに
表示されます。
